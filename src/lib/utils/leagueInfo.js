...
export const homepageText = `
  ...
  <p>Link to the accounting page: <a href="https://docs.google.com/spreadsheets/d/1tHYMcAP4pgvRHjV7HVbJE9eAhH_NcF3CoxYeM0PMoXk/edit?usp=sharing" target="_blank"> Accounting and Payouts</p>
...
export const managers = [
    {
      ...
      "philosophy": "Make terrible trades, stack up injuries.",
      "tradingScale": 8, // 1 - 10
    ...
    },
  {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Vo", // Can be anything (usually your rival's name)
