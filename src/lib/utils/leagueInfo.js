...
export const leagueName = "Cross Country Dynasty"; // your league name
...
export const managers = [
    {
      ...
      "favoritePlayer": "6757", // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
