...
<div class="constitution">
    <h1 class="noUnderscore">LEAGUE BYLAWS/CONSTITUTION</h1>
    ...
    <h3 class="noUnderscore clickable" on:click={() => goToSection(seven)}>Section 7: League Finances</h3>
        ...
        <h4 class="noUnderscore clickable" on:click={() => goToSection(sevenThree)}>7.3 Side Pot</h4>
    ...
    <p>10 Bench (Expanded by 3 between the league draft and start of regular season)</p>
	
	<p>3 Taxi Squad (Eligible players are years 1 and 2)</p>
    ...
    <div class="subBlock">
        ...
        <p>The commissioner will err on the side of letting owners manage their teams the way they see fit. Any collusion will need to be clear and deliberate. The commissioner reserves the right to step in and at the very least assess the thinking of any team involved in a heavily lop-sided trade. </p>
    </div>
    ...
    <div class="subBlock">
        <p>While the Commissioner reserves all rights to veto any trade, all teams are allowed to voice an opinion on the matter. Not liking a trade does not warrant a veto.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process Wednesday (for any waiver claims after a player played the previous week as well as any claims made Tuesday) and Friday.</p>

    <p>FAAB budgets will reset at the beginning of each season (typically transitioned after the Super Bowl).</p>
    
    
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be a linear draft in reverse order of the previous year’s final standings.</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rookie drafts will consist of 3 round of drafting, with 2 minutes alotted for each pick. To make room for the incoming players, benches will be auto-expanded by (3) spots. These spots will be removed in mid-August, at which point you will need to have cut the necessary players.</p>
    <p>Any spots not filled during the draft, can be filled immediately afterwards from the waiver wire/free agency.</p>
    ...
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. The top 6 teams in overall standings will earn a spot in the playoffs, with the top two teams receiving a first round bye. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    ...
    <p>When a manager needs to be replaced, the Commissioner will try to find a suitable candidate with some connection to at least a portion of the existing managers. Priority will be placed on managers who are eager to take on a dynasty committment and will be very active within the league.</p>
    
    <h3 bind:this={sixThree}>6.3 Replacement Incentive</h3>
    <p>In the event that a manager chooses to quit the league or is removed by the Commissioner, an incoming manager is offered a 50% reductioon on their first year buy-in.</p>

    <h2 class="sectionHeading" bind:this={seven}>Section 7 League Finances</h2>
    
    <h3 bind:this={sevenOne}>7.1 League Dues</h3>
    <p>League dues are set at {dues}$. Dues are collected through Venmo and collection will be sent out no later than the first of August. All managers must be fully paid up before week 2 of the regular season. In the event that a manager fails to pay before the deadline, a 10% penalty will be addd to their payment and will go towards the payouts at the end of the year.</p>
	...
	<h3 bind:this={sevenThree}>7.3 Side Pot</h3>
	<p>Each year, $75 out of the entire dues of the league goes towards the sidepot.</p>
	<p>Ways to win the side pot:</p>
		<li>Win the league two years in a row</li>
		<li>Go entirely undefeated (including playoffs)</li>
